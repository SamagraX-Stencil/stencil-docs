module.exports = {
  docs: [
    ...
    },
    {
      ...
      label: 'Molecules',
      collapsed: false,
      items: ['molecules/overview','molecules/loginMobileAadharPage', 'molecules/otpPage', 'molecules/feedbackPage','molecules/downtimePage','molecules/comingSoonPage','molecules/faqPage']
    },
    {
      type: 'category',
      label: 'Devops',
